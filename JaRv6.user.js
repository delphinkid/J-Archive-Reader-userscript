...
//todo: make pictures work for final jeopardy, scale font when the answer is too long (try to count <br> or something?)
  ...
  if (isPause){
    setTimeout(answerRead, 3000);
  	...
  	try{
        ...
        clueHTML = rawHTML[1].replace(reBack, "");
  ...
  if (isPause){
    ...
    try{
      ...
      if (question.length > 120){
        clue2.style.fontSize = winMult*450 + "%";
        longOne = true;
      }
      ...
      if (links.length > 1){
        ...
        //<img src="http://www.j-archive.com/media/2001-07-12_J_21.jpg" style="position: fixed; left: 0; bottom: 0; width: 400px">
        imgElement = document.createElement("img");
        imgElement.setAttribute("src", ref);
        //imgElement.setAttribute("style", "position: fixed; left: 0; bottom: 0; width: 440px");
